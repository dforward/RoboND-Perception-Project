...
##### Might need to create a passthrough filter for the Y direction also
    passthrough = cloud_filtered.make_passthrough_filter()
...
# Exercise-3 TODOs:
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        # Compute the associated feature vector and Extract histogram features
...
def pr2_mover(object_list):
    ...
    print("dict_list: for output check", dict_list)
